...
(function (global) {
  ...
  const DEFAULTS = {
    peaking: {
      ...
      paletteHint: 'deep navy base + warm sunrise gradient (orange → gold → red)',
      visualStyle: 'cinematic editorial magazine, photorealistic, premium tech aesthetic, mountain silhouettes optional',
      typography: 'bold sans-serif, large headlines, magazine layout',
      pillars: ['Tool Reviews', 'Building-in-Public', 'Marketing-Insights', 'Behind-the-Scenes'],
      signaturePhrases: ['Always peaking.', 'Built solo.', 'Public progress.', 'No VC. No hype.'],
