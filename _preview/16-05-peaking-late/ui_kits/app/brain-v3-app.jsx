...
function CanvasApp() {
  return (
    <DesignCanvas>
      <DCSection id="brain-v3" title="🧠 PEAKING Brain V3 · Unified Cross-Brand-Knowledge-Hub">
        <DCArtboard id="desktop-1440" label="Desktop · 1440 × 1024" width={1440} height={1024}>
          <BrainApp isMobile={false}/>
        </DCArtboard>
        <DCArtboard id="mobile-375" label="Mobile · 375 × 812" width={375} height={812}>
          <BrainApp isMobile={true}/>
        </DCArtboard>
      </DCSection>
    </DesignCanvas>
  );
